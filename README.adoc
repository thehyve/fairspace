...
~/bin/helm/helm pull fairspace/fairspace --version 0.7.27
----
...
[source, shell]
----
~/bin/helm/helm install fairspace-new fairspace/fairspace --version 0.7.27 --namespace fairspace-new \
...
[source, shell]
----
~/bin/helm/helm upgrade fairspace-new fairspace-0.7.27.tgz
----
