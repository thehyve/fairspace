...
~/bin/helm/helm fetch fairspace/fairspace --version 0.7.11
----
...
[source, shell]
----
~/bin/helm/helm install fairspace/fairspace --version 0.7.11 --name fairspace-new --namespace=fairspace-new \
...
[source, shell]
----
~/bin/helm/helm upgrade fairspace-new fairspace-0.7.11.tgz
----
