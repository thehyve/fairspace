...
~/bin/helm/helm pull fairspace/fairspace --version 0.7.22
----
...
[source, shell]
----
~/bin/helm/helm install fairspace-new fairspace/fairspace --version 0.7.22 --namespace fairspace-new \
...
[source, shell]
----
~/bin/helm/helm install jupyterhub-new fairspace/jupyter --version 0.8.8 --namespace jupyterhub-new \
...
[source, shell]
----
~/bin/helm/helm upgrade fairspace-new fairspace-0.7.22.tgz
----
