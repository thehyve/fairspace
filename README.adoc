...
~/bin/helm/helm pull fairspace/fairspace --version 0.7.23
----
...
[source, shell]
----
~/bin/helm/helm install fairspace-new fairspace/fairspace --version 0.7.23 --namespace fairspace-new \
...
[source, shell]
----
~/bin/helm/helm upgrade fairspace-new fairspace-0.7.23.tgz
----
