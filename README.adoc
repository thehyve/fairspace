...
* Install link:https://kubernetes.io/docs/tasks/tools/install-kubectl/[kubectl] (for Helm 3.14.x install version > 1.26.x).
...
~/bin/helm/helm helm registry login ghcr.io/fairspace/helm-charts --username <your github account> --password-stdin
...
[source, shell]
----
~/bin/helm/helm install fairspace-new fairspace/fairspace --version 0.7.31 --namespace fairspace-new \
