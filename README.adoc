...
.Example of deleting tripples (curl)
[%collapsible]
====
[source, bash]
----
...
[source, bash]
----
curl -X DELETE -G -H "Content-Type: application/ld+json" \
--data-urlencode "subject=https://example.com/ontology#tpe1" \
"http://localhost:8080/api/metadata/"
----
====
...
~/bin/helm/helm pull fairspace/fairspace --version 0.7.15
----
...
[source, shell]
----
~/bin/helm/helm install fairspace-new fairspace/fairspace --version 0.7.15 --namespace fairspace-new \
...
[source, shell]
----
~/bin/helm/helm upgrade fairspace-new fairspace-0.7.15.tgz
----
