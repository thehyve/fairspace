...
public class AuthConstants {
    public static final String AUTHORIZATION_REQUEST_ATTRIBUTE = "io.fairspace.oidc_auth.config.OAuthAuthorization";
    public static final String AUTHORIZATION_CHECKED_REQUEST_ATTRIBUTE = "io.fairspace.oidc_auth.config.AuthorizationChecked";
