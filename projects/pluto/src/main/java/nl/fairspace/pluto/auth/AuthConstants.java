...
public class AuthConstants {
    public static final String AUTHORIZATION_REQUEST_ATTRIBUTE = "nl.fairspace.pluto.auth.config.OAuthAuthorization";
    public static final String AUTHORIZATION_CHECKED_REQUEST_ATTRIBUTE = "nl.fairspace.pluto.auth.config.AuthorizationChecked";
