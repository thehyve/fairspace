...
export const TabPanel = props => {
    ...
    return <Typography component="div" role="tabpanel" hidden={value !== index} id={`workspace-tabpanel-${index}`} aria-labelledby={`workspace-tab-${index}`} {...other}>
...
const WorkspaceOverview = props => {
    ...
    return <BreadcrumbsContext.Provider value={{
        ...
        <Tabs value={selectedTab} onChange={changeTab} indicatorColor="primary" textColor="primary" aria-label="workspace tabs">
