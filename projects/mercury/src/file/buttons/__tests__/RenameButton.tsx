...
describe('<RenameButton />', () => {
  it('shows dialog when clicking on children', () => {
    const {
      container,
      queryByText
    } = render(<RenameButton onRename={() => {}} currentName="filename">
                <div>something</div>
            </RenameButton>);
  ...
  it('should not open dialog if disabled', () => {
    const {
      container,
      queryByText
    } = render(<RenameButton disabled onRename={() => {}} currentName="filename">
                <div>something</div>
            </RenameButton>);
    fireEvent.click(container.firstChild);
  ...
  it('should call onRename if not disabled', () => {
    ...
    const {
      ...
      getByTestId,
      getByLabelText
    } = render(<RenameButton onRename={onRename} currentName="filename">
                <div>something</div>
            </RenameButton>);
  ...
  it('should not find input and not call onRename if disabled', () => {
    ...
    const {
      container,
      queryByLabelText
    } = render(<RenameButton disabled onRename={onRename} currentName="filename">
                <div>something</div>
            </RenameButton>);
    fireEvent.click(container.firstChild);
