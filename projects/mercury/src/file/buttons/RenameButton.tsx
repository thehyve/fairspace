...
const RenameButton = ({
  ...
  const dialog = opened ? <FileNameDialog onClose={closeDialog} onSubmit={e => {
    e.preventDefault();
    e.stopPropagation();
    validateAndRename();
  }} submitDisabled={Boolean(!nameControl.valid)} title={`Rename ${currentName}`} control={nameControl} /> : null;
  return <>
