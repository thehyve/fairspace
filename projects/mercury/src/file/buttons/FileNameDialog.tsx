  ...
  control
        ...
        <DialogContent>
            <form data-testid="form" id="formId" noValidate onSubmit={onSubmit}>
                <ControlledTextField key="id" id="id" margin="dense" name="name" label="Name" autoFocus required fullWidth control={control} helperText="Value cannot equal '.' or '..' and cannot contain '/' or '\'." inputProps={{
        'data-testid': "Name",
        'aria-label': "Name"
      }} />
            </form>
