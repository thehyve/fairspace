...
export const FileBrowser = (props: FileBrowserProperties) => {
  ...
  return <div data-testid="files-view" className={classes.container}>
      ...
      }))} onPathCheckboxClick={path => selection.toggle(path.filename)} onPathHighlight={handlePathHighlight} onPathDoubleClick={handlePathDoubleClick} onAllSelection={shouldSelectAll => shouldSelectAll ? selection.selectAll(files.map(file => file.filename)) : selection.deselectAll()} showDeleted={showDeleted} preselectedFile={preselectedFile} />
