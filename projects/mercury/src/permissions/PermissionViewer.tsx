...
export const PermissionViewer = ({
  ...
  const renderUserPermissionComponent = () => <UserPermissionsComponent permissions={sortPermissions(collaboratingUsers)} collection={collection} setPermission={setPermission} currentUser={currentUser} workspaceUsers={workspaceUsers} />;

  const renderWorkspacePermissionComponent = () => <WorkspacePermissionsComponent permissions={sortPermissions(collaboratingWorkspaces)} setPermission={setPermission} collection={collection} />;
...
const ContextualPermissionViewer = ({
  ...
  return <PermissionViewer loading={currentUserLoading || loading} error={currentUserError || error} setPermission={setPermission} currentUser={currentUser} collaboratingUsers={collaboratingUsers} collaboratingWorkspaces={collaboratingWorkspaces} collection={collection} workspaceUsers={workspaceUsers} />;
};
