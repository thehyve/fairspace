 ...
 * @param fallbackType      fallback type to use when no metadata is found
 ...
 *  }
 */
export const fromJsonLd = (expandedMetadata, subject, vocabulary, fallbackType = null) => {
    ...
    const types = metadataItem['@type'] || (fallbackType && [fallbackType]);
