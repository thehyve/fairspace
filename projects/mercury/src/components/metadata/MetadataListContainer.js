...
const mapDispatchToProps = {
    fetch: metadataActions.fetchAllEntitiesIfNeeded,
    create: metadataActions.createMetadataEntity,
    fetchVocabulary: vocabularyActions.fetchMetadataVocabularyIfNeeded,
};
