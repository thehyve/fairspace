...
const LinkedDataInputFieldsTable = ({property, values, validationErrors, onAdd, onChange, onDelete, canAdd, labelId, addComponent, editComponent: EditComponent, onMultiLineCtrlEnter}) => {
