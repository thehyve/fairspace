// @ts-nocheck
import { compareBy, comparePrimitives, comparing, first, flattenShallow, formatDateTime, isNonEmptyValue, joinWithSeparator, stableSort, camelCaseToWords, groupBy, isEmptyObject } from "../genericUtils";
  ...
  describe('compareBy', () => {
    it('can compare by attribute', () => {
      ...
      expect([{
        ...
        a: 1
      }].sort(compareBy('a', false))).toEqual([{
        a: 3
      }, {
        a: 2
      }, {
    ...
    it('can compare by function', () => {
      expect([{
        ...
        a: 1
      }].sort(compareBy(obj => obj.a))).toEqual([{
        a: 1
      }, {
        a: 2
      }, {
      ...
      expect([{
        ...
        a: 1
      }].sort(compareBy(obj => obj.a, false))).toEqual([{
        a: 3
      }, {
        a: 2
      }, {
