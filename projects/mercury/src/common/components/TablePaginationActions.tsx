...
const TablePaginationActions = (props: TablePaginationActionsProperties) => {
  ...
  return <div className={classes.root}>
            ...
            <IconButton onClick={handleNextButtonClick} disabled={page >= Math.ceil(count / rowsPerPage) - 1} aria-label="next page" size="medium">
                <KeyboardArrowRight />
            </IconButton>
            <IconButton onClick={handleLastPageButtonClick} disabled={page >= Math.ceil(count / rowsPerPage) - 1} aria-label="last page" size="medium">
                <LastPage />
            </IconButton>
        </div>;
};
