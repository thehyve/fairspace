...
describe('CollectionList', () => {
  it('shows warning message when no collections available', () => {
    const {
      getByText
    } = render(<ThemeProvider theme={theme}><CollectionList /></ThemeProvider>);
  ...
  it('renders correct header and values columns', () => {
    ...
    const {
      queryByText
    } = render(<ThemeProvider theme={theme}><CollectionList collections={collections} showDeleted={false} /></ThemeProvider>);
  ...
  it('renders correct header and values columns in "show deleted" mode', () => {
    ...
    const {
      getByText
    } = render(<ThemeProvider theme={theme}><CollectionList collections={collections} showDeleted /></ThemeProvider>);
  ...
  it('filters collections by name on filter input change', () => {
    ...
    const wrapper = mount(<ThemeProvider theme={theme}><CollectionList collections={collections} /></ThemeProvider>);
