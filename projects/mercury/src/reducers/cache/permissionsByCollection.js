...
const removeCollaborator = (collaborators, actionMeta) =>
    collaborators ? collaborators.filter(collaborator => collaborator.subject !== actionMeta.subject) : []

const updateCollaborator = (collaborators, actionMeta) =>
    removeCollaborator(collaborators, actionMeta).concat(actionMeta)
