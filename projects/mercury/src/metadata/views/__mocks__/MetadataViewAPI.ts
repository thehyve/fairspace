...
export const mockRows = viewName => {
    switch (viewName) {
        case "Sample":
            return [{
                Sample: [{
                    value: 'http://example.com/sampleType/s01',
                    label: 'S01'
                }],
                Sample_sampleType: [{
                    value: 'http://example.com/sampleType#tissue',
                ...
                Sample_topography: [{
                    value: 'http://example.com/sampleType#lip',
                    label: 'Lip'
                }],
                ...
                Sample_nature: [{
                    value: 'http://example.com/sampleType#dna',
                    label: 'DNA'
                }],
                Sample_origin: [{
                    value: 'http://example.com/sampleType#normal',
                    label: 'Normal'
                }],
                Collection: [{
                    value: 'http://localhost:8080/api/webdav/f01',
                    label: 'f01'
                }, {
                    value: 'http://localhost:8080/api/webdav/f02',
                    label: 'f02'
                }]
            }, {
                Sample: [{
                    value: 'http://example.com/sampleType/s02',
                    label: 'S02'
                }],
                Sample_sampleType: [{
                    value: 'http://example.com/sampleType#tissue',
                ...
                Sample_topography: [{
                    value: 'http://example.com/sampleType#tongue',
                    label: 'Tongue'
                }],
                Sample_tumorCellularity: [{
                    value: 4,
                ...
                Sample_origin: [{
                    value: 'http://example.com/sampleType#tumoral',
                    label: 'Tumoral'
                }]
            }];
        ...
        case "Subject":
            return [{
                Subject: [{
                    value: 'http://example.com/sampleType/p01',
                    label: 'P01'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#male',
                    label: 'Male'
                }],
                Subject_species: [{
                    value: 'http://example.com/sampleType#hs',
                    label: 'Homo Sapiens'
                }],
                Subject_birthDate: [{
                    value: new Date(2010, 11, 25).toLocaleString(),
                    label: "2010-11-25"
                }],
                Collection: [{
                    value: 'http://localhost:8080/api/webdav/f01',
                ...
                Subject: [{
                    value: 'http://example.com/sampleType/p02',
                    label: 'P02'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#male',
                ...
                Subject: [{
                    value: 'http://example.com/sampleType/p03',
                    label: 'P03'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#female',
                    label: 'Female'
                }],
                Subject_species: [{
                    value: 'http://example.com/sampleType#hs',
                ...
                Subject: [{
                    value: 'http://example.com/sampleType/p04',
                    label: 'P04'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#male',
                ...
                Subject: [{
                    value: 'http://example.com/sampleType/p05',
                    label: 'P05'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#female',
                ...
                Subject: [{
                    value: 'http://example.com/sampleType/p06',
                    label: 'P06'
                }],
                Subject_gender: [{
                    value: 'http://example.com/sampleType#female',
        ...
        case "Resource":
            return [{
                Collection: [{
                    value: 'http://localhost:8080/api/webdav/c01',
                    label: 'C01'
                }],
