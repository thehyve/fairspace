...
export class MetadataViewAPI {
    ...
    getViews(): Promise<MetadataViews> {
        return axios
            .get(`${this.remoteURL}/`, defaultRequestOptions)
    ...
    getFacets(): Promise<MetadataFacets> {
        return axios
            .get(`${this.remoteURL}/facets`, defaultRequestOptions)
            .then(extractJsonData)
    ...
    getViewData(
        ...
        const requestOptions = cancelToken
            ? {...defaultRequestOptions, cancelToken: cancelToken.token}
            : defaultRequestOptions;

        return axios
            .post(`${this.remoteURL}/`, viewRequest, requestOptions)
            .then(extractJsonData)
    ...
    getCount(
        ...
        return axios
            .post(`${this.remoteURL}/count`, viewRequest, requestOptions)
            .then(extractJsonData)
