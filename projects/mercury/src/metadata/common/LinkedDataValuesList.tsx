...
export const LinkedDataValuesList = (props: LinkedDataValuesListProps) => {
    ...
    const renderValue = (entry, index) => rowDecorator(entry, <Grid container spacing={1} alignItems="center" onMouseEnter={() => setHoveredIndex(index)} onFocus={() => setHoveredIndex(index)} onBlur={() => setHoveredIndex(null)} onMouseLeave={() => setHoveredIndex(null)} onDoubleClick={() => onOpen(entry)}
        key={index}>
