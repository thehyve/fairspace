  ...
  return !linkedDataError && !linkedDataLoading && <>
      ...
      alignItems: "center"
        ...
        alignItems: "center"
                    ...
                    {enableDelete && <DeleteEntityButton subject={subject} isDeletable={!isDeleted && !isProtectedEntity} updateLinkedData={updateLinkedData} />}

                    <CollectionBrowserLink type={typeInfo.typeIri} filePath={values[FILE_PATH_URI]} />

                    {typeInfo.description ? <Tooltip title={<Typography variant="caption" color="inherit" style={{
          whiteSpace: 'pre-line'
        }}>
                                    {typeInfo.description}
                                </Typography>} aria-label={typeInfo.description}>
                            <Chip label={typeInfo.label || '........'} />
                        </Tooltip> : <Chip label={typeInfo.label || '........'} />}
                </Grid>
            </Grid>
