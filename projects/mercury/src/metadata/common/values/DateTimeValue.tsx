...
class DateTimeValue extends React.Component {
  ...
  render() {
    ...
    return <DateTimePicker showTodayButton openTo="year" format={`${DATE_FORMAT} HH:mm`} views={["year", "month", "date", "hours", "minutes"]} {...otherProps} value={this.state.value} onChange={this.handleChange} />;
  }
