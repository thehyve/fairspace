...
describe('LinkedDataEntityForm', () => {
  ...
  it('shows result when subject provided and data is loaded', () => {
    ...
    const wrapper = shallow(<LinkedDataEntityForm properties={defaultMetadata} values={defaultValues} subject={collection.iri} />);
  ...
  it('shows an error message if no data is available', () => {
    ...
    const wrapper = shallow(<LinkedDataEntityForm properties={defaultMetadata} values={defaultValues} subject={collection.iri} errorMessage="Testing error" />);
