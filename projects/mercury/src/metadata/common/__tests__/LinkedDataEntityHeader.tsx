...
import {COLLECTION_URI, CREATED_BY_URI, DATE_DELETED_URI, DELETED_BY_URI, DIRECTORY_URI, FILE_URI} from "../../../constants";
      ...
      const testDeleteButtonDeletableState = (values, expectedState: DeleteButtonState, editingEnabled = true) => {
          const wrapper = mount(<ThemeProvider theme={theme}>
              <VocabularyContext.Provider value={{
                  ...
                  <LinkedDataEntityHeader subject={subject} enableDelete={editingEnabled} values={values} isDeleted={values[DATE_DELETED_URI]} />
