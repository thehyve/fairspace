...
/**
 * <p>
 * A SPARQL Builder is a flow API alternative to ParameterizedSparqlString.
 * It is a SPARQL query/update into which values may be injected.
 * It has been automatically generated from ParameterizedSparqlString's source.
 * </p>
 ...
 * </p>
 */
public class SparqlBuilder implements PrefixMapping {
     ...
     */
    public SparqlBuilder(String command, QuerySolutionMap map, String base, PrefixMapping prefixes) {
        if (command != null)
     ...
     * @param base    Base URI
     */
    public SparqlBuilder(String command, QuerySolutionMap map, String base) {
     ...
     * @param prefixes Prefix Mapping
     */
    public SparqlBuilder(String command, QuerySolutionMap map, PrefixMapping prefixes) {
     ...
     * @param map     Initial Parameters to inject
     */
    public SparqlBuilder(String command, QuerySolutionMap map) {
     ...
     * @param prefixes Prefix Mapping
     */
    public SparqlBuilder(String command, String base, PrefixMapping prefixes) {
     ...
     * @param prefixes Prefix Mapping
     */
    public SparqlBuilder(String command, PrefixMapping prefixes) {
     ...
     * @param base    Base URI
     */
    public SparqlBuilder(String command, String base) {
     ...
     * @param command Raw Command Text
     */
    public SparqlBuilder(String command) {
     ...
     * @param prefixes Prefix Mapping
     */
    public SparqlBuilder(QuerySolutionMap map, PrefixMapping prefixes) {
     ...
     * @param map Initial Parameters to inject
     */
    public SparqlBuilder(QuerySolutionMap map) {
     ...
     * @param prefixes Prefix Mapping
     */
    public SparqlBuilder(PrefixMapping prefixes) {
     ...
     * {@link #appendNode(Node)return this; } methods instead
     *
     * @param command Command Text
     */
    public SparqlBuilder setCommandText(String command) {
     ...
     */
    public SparqlBuilder append(String text) {
     ...
     */
    public SparqlBuilder append(char c) {
        this.cmd.append(c);
        return this;
    }
     ...
     */
    public SparqlBuilder append(boolean b) {
        this.cmd.append(b);
        return this;
    }
     ...
     */
    public SparqlBuilder append(double d) {
        this.cmd.append(d);
        return this;
    }
     ...
     */
    public SparqlBuilder append(float f) {
        this.cmd.append(f);
        return this;
    }
     ...
     */
    public SparqlBuilder append(int i) {
        this.cmd.append(i);
        return this;
    }
     ...
     */
    public SparqlBuilder append(long l) {
        this.cmd.append(l);
        return this;
    }
     ...
     */
    public SparqlBuilder append(Object obj) {
        this.cmd.append(obj);
        return this;
    }
     ...
     */
    public SparqlBuilder appendNode(Node n) {
     ...
     * @param n Node to append
     */
    public SparqlBuilder appendNode(RDFNode n) {
     ...
     */
    public SparqlBuilder appendIri(String uri) {
     ...
     */
    public SparqlBuilder appendIri(IRI iri) {
     ...
     */
    public SparqlBuilder appendLiteral(String value) {
     ...
     * @param lang  Language
     */
    public SparqlBuilder appendLiteral(String value, String lang) {
     ...
     */
    public SparqlBuilder appendLiteral(String value, RDFDatatype datatype) {
     ...
     * @param b Boolean to append
     */
    public SparqlBuilder appendLiteral(boolean b) {
     ...
     * @param i Integer to append
     */
    public SparqlBuilder appendLiteral(int i) {
     ...
     * @param l Long to append
     */
    public SparqlBuilder appendLiteral(long l) {
     ...
     * @param f Float to append
     */
    public SparqlBuilder appendLiteral(float f) {
     ...
     * @param d Double to append
     */
    public SparqlBuilder appendLiteral(double d) {
     ...
     */
    public SparqlBuilder appendLiteral(Calendar dt) {
     ...
     * see the command with injected parameters invoke the {@link #toString()return this; }
     * method
     * </p>
     *
     * @return Command Text
     ...
     * @param base Base URI
     */
    public SparqlBuilder setBaseUri(String base) {
        this.baseUri = base;
        return this;
    }
     ...
     * @param n Node
     */
    protected SparqlBuilder validateParameterValue(Node n) {
        if (n.isURI()) {
     ...
     */
    public SparqlBuilder setParams(QuerySolutionMap map) {
        if (map != null) {
     ...
     * @param n     Node
     */
    public SparqlBuilder setParam(int index, Node n) {
        if (index < 0)
     ...
     * @param n   Value
     */
    public SparqlBuilder setParam(String var, Node n) {
        if (var == null)
     ...
     * @param n     Node
     */
    public SparqlBuilder setParam(int index, RDFNode n) {
     ...
     * @param n   Value
     */
    public SparqlBuilder setParam(String var, RDFNode n) {
     ...
     * @param iri   IRI
     */
    public SparqlBuilder setIri(int index, String iri) {
     ...
     * @param iri IRI
     */
    public SparqlBuilder setIri(String var, String iri) {
     ...
     * @param iri   IRI
     */
    public SparqlBuilder setIri(int index, IRI iri) {
     ...
     * @param iri IRI
     */
    public SparqlBuilder setIri(String var, IRI iri) {
     ...
     * @param url   URL
     */
    public SparqlBuilder setIri(int index, URL url) {
     ...
     */
    public SparqlBuilder setIri(String var, URL url) {
     ...
     * @param lit   Value
     */
    public SparqlBuilder setLiteral(int index, Literal lit) {
     ...
     * @param lit Value
     */
    public SparqlBuilder setLiteral(String var, Literal lit) {
     ...
     * @param value Lexical Value
     */
    public SparqlBuilder setLiteral(int index, String value) {
     ...
     * @param value Lexical Value
     */
    public SparqlBuilder setLiteral(String var, String value) {
     ...
     * @param lang  Language
     */
    public SparqlBuilder setLiteral(int index, String value, String lang) {
     ...
     * @param lang  Language
     */
    public SparqlBuilder setLiteral(String var, String value, String lang) {
     ...
     * @param datatype Datatype
     */
    public SparqlBuilder setLiteral(int index, String value, RDFDatatype datatype) {
     ...
     * @param datatype Datatype
     */
    public SparqlBuilder setLiteral(String var, String value, RDFDatatype datatype) {
     ...
     * @param value boolean
     */
    public SparqlBuilder setLiteral(int index, boolean value) {
     ...
     * @param value boolean
     */
    public SparqlBuilder setLiteral(String var, boolean value) {
     ...
     */
    public SparqlBuilder setLiteral(int index, int i) {
     ...
     * @param i   Integer Value
     */
    public SparqlBuilder setLiteral(String var, int i) {
     ...
     */
    public SparqlBuilder setLiteral(int index, long l) {
     ...
     * @param l   Integer Value
     */
    public SparqlBuilder setLiteral(String var, long l) {
     ...
     * @param f     Float value
     */
    public SparqlBuilder setLiteral(int index, float f) {
     ...
     * @param f   Float value
     */
    public SparqlBuilder setLiteral(String var, float f) {
     ...
     */
    public SparqlBuilder setLiteral(int index, double d) {
     ...
     * @param d   Double value
     */
    public SparqlBuilder setLiteral(String var, double d) {
     ...
     */
    public SparqlBuilder setLiteral(int index, Calendar dt) {
     ...
     * @param dt  Date Time value
     */
    public SparqlBuilder setLiteral(String var, Calendar dt) {
     ...
     * @param var Variable
     */
    public SparqlBuilder clearParam(String var) {
        this.params.remove(var);
     ...
     * @param index Positional Index
     */
    public SparqlBuilder clearParam(int index) {
        this.positionalParams.remove(index);
        return this;
    }
     ...
     */
    public SparqlBuilder clearParams() {
        this.params.clear();
     ...
     * @throws ARQException Thrown if not safe to inject, error message will describe why
     *                      it is unsafe to inject
     */
    protected SparqlBuilder validateSafeToInject(String command, String var, Node n) throws ARQException {
     ...
     *
     * @param command  Current command string
     * @param index    Positional parameter index
     * @param position Position within the command string at which the positional
     *                 parameter occurs
     * @param n        Value to inject
     * @throws ARQException Thrown if not safe to inject, error message will describe why
     *                      it is unsafe to inject
     */
    protected SparqlBuilder validateSafeToInject(String command, int index, int position, Node n) throws ARQException {
        // Parse out delimiter info
        DelimiterInfo delims = this.findDelimiters(command);
    ...
    protected final String stringForNode(Node n, SerializationContext context) {
        ...
        if (n.isLiteral() && str.contains("'")) {
            // Should escape ' to aSparqlBuilder a possible injection vulnerability
            str = str.replace("'", "\\'");
        }
        return str;
    }
     ...
     * </p>
     *
     * @throws ARQException May be thrown if the code detects a SPARQL Injection
     ...
     * @throws QueryException Thrown if the command text does not parse
     */
     ...
     * @return Copy of the string
     */
    public SparqlBuilder copy(boolean copyParams) {
     ...
     * @return Copy of the string
     */
    public SparqlBuilder copy(boolean copyParams, boolean copyBase, boolean copyPrefixes) {
        SparqlBuilder copy = new SparqlBuilder(this.cmd.toString(), null,
     ...
     * @param items
     */
    public SparqlBuilder setValues(String valueName, Collection<? extends RDFNode> items) {
     ...
     * @param item
     */
    public SparqlBuilder setValues(String valueName, RDFNode item) {
     ...
     * @param itemsMap
     */
    public SparqlBuilder setValues(Map<String, Collection<? extends RDFNode>> itemsMap) {
     ...
     * @param rowItems
     */
    public SparqlBuilder setRowValues(String valueName, Collection<List<? extends RDFNode>> rowItems) {
