...
import io.fairspace.saturn.auth.Security;
...
public class SaturnDatasetFactory {
    ...
    public static Dataset connect(Config config) {
        ...
        var txnLogDatasetGraph = new TxnLogDatasetGraph(baseDatasetGraph, txnLog, Security::userInfo, CommitMessages::getCommitMessage);
