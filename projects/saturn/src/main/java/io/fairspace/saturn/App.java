...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var metadataService = new ChangeableMetadataService(rdf, defaultGraphIRI, VOCABULARY_GRAPH_URI, CONFIG.jena.metadataTripleLimit, metadataLifeCycleManager, metadataValidator);
