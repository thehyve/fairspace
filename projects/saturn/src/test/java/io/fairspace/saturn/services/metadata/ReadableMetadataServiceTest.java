...
public class ReadableMetadataServiceTest {
    private static final String userVocabularyURI = "http://localhost:3000/iri/user-vocabulary";
    ...
    private static final Resource S3 = createResource("http://localhost:3000/iri/S3");
