...
const correct_response = [
    ...
    {key: "http://fairspace.io/ontology#name", label: 'Name', values: [{'@value': 'Collection 5'}]},
    {key: "@type", label: "Type", values: [{"@id": "http://fairspace.io/ontology#Collection", "rdfs:label": "Collection"}]}
    ];
